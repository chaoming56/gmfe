import React, { ChangeEvent, Component, createRef, CSSProperties, InputHTMLAttributes } from 'react'
...
export default class InputNumberV2 extends Component<InputNumberV2Props, InputNumberV2State> {
  static defaultProps = {
    value: null,
    precision: 2,
  }
