...
module.exports = {
  ...
  stories: [
    '../packages/business/src/**/*stories.(js|tsx)',
    '../packages/cropper/src/**/*stories.(js|tsx)',
    ...
    '../packages/react/src/**/*stories.(js|tsx)',
    '../packages/react-deprecated/src/**/*stories.js',
    '../packages/sortable/src/**/*stories.(js|tsx)',
    '../packages/table/src/**/*stories.js',
    '../packages/table-x/src/**/*stories.(js|tsx)',
    '../packages/tour/src/**/*stories.(js|tsx)',
    '../demo/**/*stories.js',
  ],
  webpackFinal,
}
